...
public class EnabledBehavior : IBehaviorHandler
{
    public bool CanHandle(string propertyName)
    {
        return propertyName == "IsEnabled";
    }
    ...
    {
        output["data-binding-enabled"] = ExtractBinding(value);
    }
    ...
    private string ExtractBinding(string value)
    {
        ...
        var inner = value.Replace("{Binding", "").Replace("}", "").Trim();
